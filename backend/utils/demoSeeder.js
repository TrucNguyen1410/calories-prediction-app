// Logic seed dữ liệu demo dùng chung cho:
//   - scripts/seed_demo.js (chạy CLI: node scripts/seed_demo.js)
//   - route POST /api/admin/seed-demo (trigger từ xa qua HTTP, không cần mở terminal)
...
import { computeBMI } from "./health.js";
...
export async function seedDemoUser() {
    ...
    return {
        ...
        chatSessions: chatSamples.length,
    };
}
